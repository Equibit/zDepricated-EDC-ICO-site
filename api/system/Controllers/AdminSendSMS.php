...
class AdminSendSMS extends BaseAPIController {
    function post_xhr($templateName) {
        if ($this->checkAuth()) {
            ...
            echo json_encode(StatusReturn::S200($newUser->sendSMSNotification($templateName, null, $_POST['useLanguages'])), JSON_NUMERIC_CHECK);
        }
    }
}